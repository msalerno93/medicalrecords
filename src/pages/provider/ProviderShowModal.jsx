...
const [data, setData] = useState([]);
  ...
  return (
    <div className="pt-28 px-5 text-center">
      <h1 className="text-3xl font-bold">{data.lastName}, {data.firstName}</h1>
            ...
            <form action="" method="PUT" onSubmit={updateProvider}>
              <div className="grid grid-cols-2">
                    ...
                    <div className="flex p-1 text-lg font-bold">
                      <p>Street</p>{" "}
                      <input
                        onChange={(e) => setEditProvider({...editProvider, street: e.target.value})}
                    ...
                    <div className="flex p-1 text-lg font-bold">
                      <p>State</p>{" "}
                      <input
                        onChange={(e) => setEditProvider({...editProvider, state: e.target.value})}
                    ...
                    <div className="flex p-1 text-lg font-bold">
                      <p>Zip</p>{" "}
                      <input
                        onChange={(e) => setEditProvider({...editProvider, zipCode: e.target.value})}
                    ...
                    <div className="flex p-1 text-lg font-bold">
                      <p>Phone</p>{" "}
                      <input
                        onChange={(e) => setEditProvider({...editProvider, phoneNumber: e.target.value})}
                    ...
                    <div className="flex p-1 text-lg font-bold">
                      <p>Fax</p>{" "}
                      <input
                        onChange={(e) => setEditProvider({...editProvider, faxNumber: e.target.value})}
                    ...
                    <div className="flex p-1 text-lg font-bold">
                      <p>Tax ID</p>{" "}
                      <input
                        onChange={(e) => setEditProvider({...editProvider, taxIdNumber: e.target.value})}
                    ...
                    <div className="flex p-1 text-lg font-bold">
                      <p>NPI</p>{" "}
                      <input
                        onChange={(e) => setEditProvider({...editProvider, npiNumber: e.target.value})}
